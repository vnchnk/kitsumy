...
/**
 * Smart bubble sizing based on text content
 * Returns dimensions as percentages of panel size
 */
export function calculateBubblePercentages(
  ...
  return {
    widthPercent: (dimensions.width / panelWidth) * 100,
    heightPercent: (dimensions.height / panelHeight) * 100,
    adjustedFontSize: dimensions.fontSize,
  };
}
